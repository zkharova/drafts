...
'С самого первого класса их называли','','',' посёлка – такое приятно вспомнить. Все было очень душевно, пока Наташа не сказала '
'«Я ','','','','». Чтобы всех отвлечь, кому-то пришлось вытащить из кармана','','и кинуть прямо в ','',', который странным образом '
'тоже был на этой встрече выпускников. Дима встал и начал','','. Он был таким','',', что Наташа стукнула его','',' , '
'который лежал у костра.  Все успокоились, обнялись и сели','',', чтобы помечтать','','.']
...
'.Забравшись в здание, он обрадовался и начал','','. За этим его и застали приверженцы секты','',' ','',' . '
...
text_story3 = ['Утром ты и твоя', '', 'проснулись в палатке в лесу – вы поехали вместе в поход. Выглядели вы, надо сказать,','',
'после','','.''Вы решили выйти прогуляться, и прошли уже два метра, когда встретили','', 'с гигантскими','','.'
'Он хотел атаковать вас, но ты выхватил','', ' , чтобы защититься. Однако вместо этого ты зачем-то положил ваше оружие.'
...
'поэтому она собрала ','','и остальные необходимые вещи, надела','', ',села на','',' и поехала покорять столицу. '
'На дороге она нашла много шоколадных','','  и съела их. Увидев это, ','',', встретившийся с ней по дороге,','',' ,'
' сказал, что она слишком','',' , чтобы куда-либо ехать. Он забрал ее с собой и они на частном','',' '
' уехали на Мальдивы.']
...
'Оказалось, интервью будет парным – он окажется там','','. При входе журналист предложил ему','',', но он отказался,'
'сказав «я уже и так достаточно','' ,'извините». Наш герой удобно присел','' ', где для него приготовили место','',
', но вдруг понял, что не хочет интервью, а хочет начать новую жизнь, без популярности и','', '.' 
'Он встал и стремительно','', '.']

# нажатие кнопки, выбор истории, создается объект класса Story с атрибутами выбранного мода
# словарь с примерами (examples)
